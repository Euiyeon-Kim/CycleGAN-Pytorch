...
parser.add_argument('--num_workers', type=int, default=0, help="# of cpu threads to use during batch generation")
...
parser.add_argument('--use_ident', type=bool, default=False, help="Whether to use identity loss or not")
